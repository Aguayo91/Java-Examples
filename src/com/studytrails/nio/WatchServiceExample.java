...
public class WatchServiceExample {
	// TODO how to monitor a directory for changes
	// java 7 implemented the watch service which can be used to watch changes
	// in a directory.
	// the watch service is thread safe and hence multiple threads can use it.
