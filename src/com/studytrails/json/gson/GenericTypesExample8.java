...
public class GenericTypesExample8 {
	public static void main(String[] args) {
		...
		// In contrast to above where we read the json back using the Animal2
